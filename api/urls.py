...
urlpatterns = [
    ...
    path('howtos/<str:uri_id>/publish/',
         howto_views.HowToPublishView.as_view(),
         name='how-to-publish'),
    ...
    path('steps/<str:uri_id>/linkableimages/',
         step_views.StepLinkableImagesView.as_view(),
         name='step-linkable-images'),

    # Decision Views
    path('steps/<str:uri_id>/decisions/',
         step_views.DecisionView.as_view(),
         name='decision-step'),
    path('steps/<str:uri_id>/linkable-decisions/',
    ...
    # Guide Views
    path('guides/howtos/<str:space>/',
         guide_views.HowToGuideListView.as_view(),
         name='howto-guide-list'),
    path('guides/howto/step/',
         guide_views.StepGuideListView.as_view(),
         name='step-guide-list'),
    path('guides/howto/<str:uri_id>/<str:space>/',
         guide_views.HowToGuideView.as_view(),
         name='howto-guide'),
    path('guides/howto/<str:howto_uri_id>/<str:step_uri_id>/<str:ref_id>/',
    ...
    path('media/images/',
         ...
         name='images'),
    path('media/images/<str:uri_id>',
         media_views.ImageDetailView.as_view(),
         name='image-detail'),
    path('media/<str:uri_id>.<str:media_type>/',
