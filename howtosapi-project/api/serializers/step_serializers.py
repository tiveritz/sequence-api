...
class StepSerializer(serializers.HyperlinkedModelSerializer): # TEST OK
...
class StepSimpleSerializer(serializers.HyperlinkedModelSerializer): #TEST OK
...
class StepDetailSerializer(serializers.ModelSerializer):  #TEST OK
...
class SubstepSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):  #TEST OK (partly)
        """
